...
//open edit modal
function edit_movie(){
   $.get('/movies/names',function(response, status){
...
function add_db(){
    ...
    if(count == 5){
        ...
        $.post('/movies/add',dict, function(response, status){
...
function edit_db(){
    ...
    console.log("form edkited data dict",form_data_dict) ;
     $.post('/movies/edit',form_data_dict, function(response, status){
        console.log("Successfully posted");
...
function del_db(){
    ...
    if(movie_name.value == ''){
       ...
       $.post('/movies/delete',form_data_dict, function(response, status){
            console.log("Successfully posted");
            close_me('myModaldel');
            location.reload();
       })
...
function search_movie(){
    ...
    if(movie_name == ''){
        ...
        var form_data_dict = {}
        form_data_dict['movie_name'] = movie_name;
        $.post('/movies/search',form_data_dict, function(response, status){
            resp = JSON.parse(response);
